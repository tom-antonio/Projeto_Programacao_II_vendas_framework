...
public class FormVendaProduto extends JDialog {
    ...
    private void selecionarProduto() {
        ...
        produtoVendaSelecionado = new ProdutoVenda();
        produtoVendaSelecionado.setProduto(produto);
        produtoVendaSelecionado.setQtdeProduto(quantidade);
        produtoVendaSelecionado.setValorUnit(valorUnitario);
        dispose();
    }
